...
final class Version20190217181253 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE document_de_reference (id INT AUTO_INCREMENT NOT NULL, corporation_id INT NOT NULL, chiffre_affaire BIGINT NOT NULL, benefices_groupe BIGINT NOT NULL, dividend BIGINT NOT NULL, salaire_moyen INT NOT NULL, on_profit_tax_paid INT NOT NULL, year DATE NOT NULL, INDEX IDX_DC520A6BB2685369 (corporation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
