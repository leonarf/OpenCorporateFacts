 ...
 */
final class Version20181226163054 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte_de_resultat ADD benefice INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte_de_resultat DROP benefice');
